...
export async function main(ns: NS) {
	...
	const files = [
		...
		{_: ns.tprint("Downloading page.ts..."),name: "page.ts",success: await ns.wget("https://raw.githubusercontent.com/EphyMusic/BitBurner/refs/heads/main/unBasic/lib/page.ts","unBasic/lib/page.ts", "home"),manual: "wget https://raw.githubusercontent.com/EphyMusic/BitBurner/refs/heads/main/unBasic/lib/page.ts unBasic/page.ts"}
	];
